...
export const button = cva(
  "flex items-center font-medium jsutify-center gap-x-2 text-gray-100 active:scale-[98%] w-max active:opacity-90 duration-200",
  {
    variants: {
      variant: {
        primary:
...
export const input = cva(
  "focus-within:ring-2 bg-inherit text-blue-500 focus-within:outline-none w-full focus-within:border-gray-400 focus-within:ring-offset-2 border border-zinc-300 duration-300",
  {
    variants: {
      sizes: {
        sm: "px-3 py-2 text-sm",
...
export const flexbox = cva("flex gap-2 w-full", {
  variants: {
    justify: {
      start: "justify-start",
